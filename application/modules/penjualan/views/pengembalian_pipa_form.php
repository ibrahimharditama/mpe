		...
		<div class="row">
			<div class="col-4">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <select class="select2 w-100 id_pengiriman" name="id_pengiriman" data-placeholder="Pilih No. Pengiriman">
                            <option value=""></option>
		...
		<table class="table-cell table-item">
                    ...
                    <?php foreach ($data['detail'] as $row): ?>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="hidden" name="produk[qty_bawa][]" class="input-qty-bawa" value="<?= $row['qty_bawa']; ?>">
                                <input type="text" name="produk[qty_kembali][]" class="control-number w-100 input-qty" value="<?= $row['qty_kembali']; ?>">
			...
			<tfoot>
				<tr>
					...
					<td>
                        <input type="text" name="qty" class="control-number input-total w-100 semi-bold" value="<?= $data != null ? $data['qty'] : 0; ?>" readonly>
                    </td>
					<td colspan="2"></td>
				</tr>
...
<script>
    ...
    $('.id_pengiriman').on('select2:select', function() {
        ...
        $.getJSON( site_url + 'penjualan/pengembalian-pipa/ajax_get_detail_pengembalian/' + id_pengiriman, function(result) {
            console.log(result);
            ...
            $.each(result, function(index, row) {
                html += `<tr>
                            ...
                            <td>
                                ...
                                <input type="hidden" name="produk[id_satuan][]" value="`+row.id_satuan+`">
                                <input type="hidden" name="produk[satuan][]" value="`+row.satuan+`">
                                <input type="hidden" name="produk[qty_bawa][]" class="input-qty-bawa" value="`+row.qty+`">
