...
<body>
    ...
    <table>
        <tr>
            ...
            <td width="100%" class="t-center v-top" colspan="3">
    ...
    <table style="padding-top: 6px;">
        <tr class="table-header">
            <td width="30px">No.</td>
            <td colspan="3">Nama Item</td>
            <td class="t-center" width="30px">Jml Bawa</td>
            <td class="t-center" width="30px">Jml Kembali</td>
            <td class="t-center" width="30px">Jml Pakai</td>
        </tr>
        <?php $no=1; $total_item=0;foreach($detail as $dtDetail):?>
        <tr class="table-body">
            <td><?= $no++; ?></td>
            <td colspan="3"><?= $dtDetail->nama; ?></td>
            <td class="t-center"><?= $dtDetail->qty_bawa; ?></td>
            <td class="t-center"><?= $dtDetail->qty_kembali; ?></td>
            <td class="t-center"><?= $dtDetail->qty_bawa-$dtDetail->qty_kembali; ?></td>
        </tr>
        <?php endforeach;?>
        ...
        <tr>
            <td colspan="4" class="f-size-9 f-verdana">
