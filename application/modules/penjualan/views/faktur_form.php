            ...
            <div class="row">
                ...
                <div class="col-5">
                    ...
                    <div class="form-group row button-action" style="display: none;">
                        ...
                        <div class="col-sm-9">
                            <a class="btn btn-outline-info" id="do-bayar" href="#" data-toggle="modal"
...
function load_pesanan() {
    ...
    $('[name=id_penjualan]').data('placeholder', 'Memuat data...').select2({
        allowClear: true
    });
    ...
    $.post(
        ...
        function(response) {
            ...
            $('[name=id_penjualan]').data('placeholder', 'Pilih Pesanan').select2({
                allowClear: true
            });
