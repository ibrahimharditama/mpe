    ...
    <?php $start=0; $no=1; $total_item=0; for ($i=1; $i <= $table_count; $i++): ?>
            ...
            <tr>
                ...
                <td width="66.7%">
                    <table>
                        <tr>
                            <td class="t-center">
                                <span class="fw-bold f-arial f-size-16">PENGEMBALIAN PIPA</span><br>
                                <span class="fw-bold f-arial f-size-12">No. SP : <?= $header->no_transaksi; ?></span>
                            </td>
        ...
        <table style="margin-top: 5px;">
            <tr class="table-header">
                ...
                <td width="15%" class="t-right">Jml Bawa</td>
                <td width="15%" class="t-right">Jml Kembali</td>
                <td width="15%" class="t-right">Jml Pakai</td>
            </tr>
            <?php foreach(array_slice($detail, $start, 10) as $dtDetail): ?>
                <tr class="table-body">
                    <td><?= $no++; ?></td>
                    <td><?= $dtDetail->nama; ?></td>
                    <td class="t-right"><?= number_format($dtDetail->qty_bawa); ?></td>
                    <td class="t-right"><?= number_format($dtDetail->qty_kembali); ?></td>
                    <td class="t-right"><?= number_format($dtDetail->qty_bawa-$dtDetail->qty_kembali); ?></td>
                </tr>
                <?php $total_item += $dtDetail->qty_bawa-$dtDetail->qty_kembali; ?>
            <?php endforeach; ?>
                            ...
                            <td width="35%" class="v-top">
                                <table>
                                    <tr class="table-footer">
                                        <td class="fw-bold" width="50%"><span class="fw-bold">Total Item Pakai</span></td>
                                        <td>:</td>
