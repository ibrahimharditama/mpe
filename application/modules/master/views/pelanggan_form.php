...
<h1 class="my-header">Form Pelanggan</h1>
		...
		<div class="row">
			<div class="col-6">
				<div class="form-group row">
					<label class="col-sm-4 col-form-label pr-0">Kode Pelanggan</label>
					<div class="col-sm-8">
						<input type="text" class="form-control" name="kode" placeholder="Dibuat otomatis" value="<?php if ($data != null) echo $data['kode']; ?>" readonly>
					</div>
				</div>
				<div class="form-group row">
					<label class="col-sm-4 col-form-label pr-0"><span class="text-danger">*</span> Nama Pelanggan</label>
					<div class="col-sm-8">
...
<div class="actionbar fixed-bottom">
	...
	<a class="btn btn-outline-secondary ml-1" href="<?php echo site_url('master/pelanggan') ?>">
