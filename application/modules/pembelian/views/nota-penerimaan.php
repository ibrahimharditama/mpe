...
<body>
    ...
    <table>
        <tr>
            ...
            <td width="450px" class="t-center v-top" colspan="3">
                <span class="fw-bold f-arial f-size-16">PENERIMAAN</span><br>
    ...
    <table style="padding-top: 6px;">
        ...
        <tr>
            <td colspan="5"></td>
            <td class="f-size-9 f-verdana fw-400">Uang Muka</td>
            <td class="f-size-9 f-verdana fw-400">:</td>
        ...
        <tr>
            <td colspan="5"></td>
            <td class="f-size-9 f-verdana fw-400">Keterangan Biaya Lain</td>
            <td class="f-size-9 f-verdana fw-400">:</td>
            <td class="t-right f-verdana f-size-9 fw-400"><?=$header->keterangan_biaya_lain?></td>
        </tr>
        <tr>
            <td colspan="5"></td>
            <td class="f-size-9 f-verdana fw-400">Sisa Pembayaran</td>
            <td class="f-size-9 f-verdana fw-400">:</td>
